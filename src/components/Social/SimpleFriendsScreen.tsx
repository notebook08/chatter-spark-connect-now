...
import { Users, UserPlus, Search, MessageCircle, Heart, Star } from "lucide-react";
import { useSimpleFriends } from "@/hooks/useSimpleFriends";

interface SimpleFriendsScreenProps {
  onStartChat?: (userId: string) => void;
  onStartVideoCall?: (userId: string) => void;
}

export function SimpleFriendsScreen({ onStartChat, onStartVideoCall }: SimpleFriendsScreenProps) {
